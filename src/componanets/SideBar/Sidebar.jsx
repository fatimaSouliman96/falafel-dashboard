     ...
     <Navbar  expand="lg" light >
        ...
        <Collapse navbar id="navbarSupportedContent">
          <Navbar.Nav mr="auto">
            ...
            <Nav.Link onClick={ () => dropShow() } to="/falafel-dashboard/main-bills" className="navLink "><RiBillFill size={30} style={{marginRight: "0.4rem"}}/>ادارة الفواتير<IoIosArrowDropdown className={dropDown} style={{marginRight:"1rem"}} size={25} /> <IoIosArrowDropup className={dropUp} style={{marginRight:"1rem"}} size={25}/></Nav.Link>
              <ul className={drop}>
